 ...
 * @subpackage Daily_Posts_Report/admin
 */
 ...
 */
class Daily_Posts_Report_Admin {
	...
	public function enqueue_styles() {
		...
		wp_enqueue_style( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'css/daily-posts-report-admin.css', array(), $this->version, 'all' );
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'js/daily-posts-report-admin.js', array( 'jquery' ), $this->version, false );
